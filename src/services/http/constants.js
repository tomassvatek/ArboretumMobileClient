...
export const GET_CLOSEST_TREE_ENDPOINT = `${API_BASE_URL}/trees/closest/{count}?latitudeMin={latMin}&latitudeMax={latMax}&longitudeMin={lonMin}&longitudeMax={lonMax}&latitude={latitude}&longitude={longitude}`;
